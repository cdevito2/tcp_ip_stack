...
graph_t * build_first_topo(){
    ...
    insert_link_between_two_nodes(R0_re,R1_re, "eth0","eth1",1);
    insert_link_between_two_nodes(R1_re,R2_re, "eth2","eth3",1);
    insert_link_between_two_nodes(R0_re,R2_re, "eth4","eth5",1);
...
graph_t * build_linear_topo(){
    ...
    node_set_intf_ip_address(H2,"eth3","20.1.1.1",24);
